...
func NewLogger(outputf io.Writer, prefix string, flag int) Logger {
	return &logger{l: log.New(outputf, prefix, flag)}
}
...
func (l *logger) outputf(level, format string, v ...interface{}) {
